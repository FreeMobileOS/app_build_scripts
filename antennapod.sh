...
EOF
	...
	cp -f app/build/outputs/apk/free/release/app-free-release.apk $PRODUCT_OUT_PATH/AntennaPod.apk
else
	./gradlew assembleDebug
	cp -f app/build/outputs/apk/free/debug/app-free-debug.apk $PRODUCT_OUT_PATH/AntennaPod.apk
fi
